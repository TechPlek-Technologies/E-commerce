  ...
  return (
    <div className="col-xl-9 mt-65">
              <div className="service-details-content">
               ...
               <h3>Diabetes Care</h3>
                <p>
                  Common problems in diabetes. Even though diabetes can lead to
                  other health problems, you can prevent or delay these
                ...
                <p>
                  Learn how to prevent or delay these diabetes complications and
                ...
                <ul className="list-style-two pt-10 pb-20">
                  ...
                  <li>
                    Women might notice frequent urinary tract infections, yeast
                    infection and dry and itchy skin.
                  </li>
                </ul>
               </div>
